            ...
            <div className=" col-md-4 col-12">
              <div className="instruction">
                ...
                <p>
                  ...
                  valid, the first image will be opened. Also, if you open the
                  light-box you will see a button (another component) which uses
                  another hook to close the light-box.
                </p>
                <input
                  type="number"
                  value={value}
